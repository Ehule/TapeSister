...
static void fx_return_is_wet_return_not_master(void)
{
    ...
    p.fx.slot[0].parameter_a = 1.0f;
    p.fx.slot[0].parameter_b = 0.5f;
    p.fx.slot[0].mix = 1.0f;
    p.fx.slot[1].enabled = 0;
    p.fx.slot[2].enabled = 0;
    p.fx.slot[3].enabled = 0;
