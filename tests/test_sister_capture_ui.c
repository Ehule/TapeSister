...
int main(void)
{
    ...
    CHECK(ts_sister_ui_hit_test(12, 334).action == TS_SISTER_UI_ACTION_TAP);
    CHECK(ts_sister_ui_hit_test(78, 334).action == TS_SISTER_UI_ACTION_CAPTURE_FORMAT);
    CHECK(ts_sister_ui_hit_test(130, 334).action == TS_SISTER_UI_ACTION_DESTINATION);
