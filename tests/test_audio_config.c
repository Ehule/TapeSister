...
static int test_roundtrip(void)
{
    ...
    saved.prism_zoya_pose = TS_PRISM_ZOYA_POSE_OFF;
    ...
    ok = expect(strcmp(loaded.record_input_device, "Test Capture Device") == 0,
         ...
         expect(loaded.prism_zoya_pose == TS_PRISM_ZOYA_POSE_OFF,
                "Prism Zoya off preference should survive audio-config saves") &&
