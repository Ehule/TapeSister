...
typedef enum {
    ...
    TS_AUDIO_BACKEND_JACK,
    TS_AUDIO_BACKEND_PIPEWIRE,
    TS_AUDIO_BACKEND_PULSEAUDIO,
    TS_AUDIO_BACKEND_ALSA,
    TS_AUDIO_BACKEND_COREAUDIO,
    TS_AUDIO_BACKEND_WINMM,
    TS_AUDIO_BACKEND_OSS,
    TS_AUDIO_BACKEND_SNDIO,
    TS_AUDIO_BACKEND_NETBSD,
    TS_AUDIO_BACKEND_AAUDIO,
    TS_AUDIO_BACKEND_OPENSLES,
    TS_AUDIO_BACKEND_ASIO,
    TS_AUDIO_BACKEND_COUNT
} TsAudioBackend;
