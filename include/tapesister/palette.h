...
typedef enum {
    ...
    TS_PALETTE_MOSAIC_HIGHLIGHT,
    TS_PALETTE_MOSAIC_TILE_1,
    TS_PALETTE_MOSAIC_TILE_2,
    TS_PALETTE_MOSAIC_TILE_3,
    TS_PALETTE_MOSAIC_TILE_4,
...
enum {
    ...
    TS_PALETTE_MOSAIC_COLOR_COUNT = 6
};

#define TS_PALETTE_ALL_COLORS (UINT32_MAX >> (32 - TS_PALETTE_COLOR_COUNT))
