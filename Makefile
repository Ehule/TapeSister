...
tapesister_keyboard_sustain_tests: tests/test_waveform_native.inc tests/test_playback_continuity.inc $(CORE) tests/test_keyboard_sustain.c src/main_sdl.c src/main_sdl_portal.inc $(wildcard src/main_sdl_audio*.inc) src/tape_link.c src/tape_companion.c $(DIAG) $(MIDI_C)
