...
tapesister tapesister_portal_controller_tests tapesister_keyboard_sustain_tests: src/main_sdl_mosaic.inc src/main_sdl_mosaic_editor.inc src/main_sdl_mosaic_volume.inc src/ts_mosaic_ui.inc include/tapesister/mosaic.h
...
tapesister_core_tests: $(CORE) tests/test_core.c
	$(CC) $(CFLAGS) $(CPPFLAGS) $(CORE) tests/test_core.c -o $@ -lm
...
tapesister_keyboard_sustain_tests: tests/test_canvas_play_view.inc tests/test_waveform_workspaces.inc tests/test_waveform_native.inc tests/test_playback_continuity.inc $(CORE) tests/test_keyboard_sustain.c src/main_sdl.c src/main_sdl_portal.inc $(wildcard src/main_sdl_audio*.inc) src/tape_link.c src/tape_companion.c $(DIAG) $(MIDI_C)
...
.PHONY: test-mosaic
test: test-mosaic
test-mosaic: tapesister_mosaic_tests tapesister_mosaic_controller_tests
...
tapesister_mosaic_controller_tests: tests/test_mosaic_controller.c tests/test_mosaic_volume_controls.inc $(CORE) src/main_sdl.c src/main_sdl_mosaic.inc src/main_sdl_mosaic_editor.inc src/main_sdl_mosaic_volume.inc src/main_sdl_portal.inc src/tape_link.c src/tape_companion.c $(DIAG) $(MIDI_C)
