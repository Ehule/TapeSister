...
sequence members. Selected lenses support arrow-key fine tuning/panning and
Shift-Up/Down octave steps. Drift now has a Rate control, and Group Oct transposes
