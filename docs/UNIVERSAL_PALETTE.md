...
Every universal save writes and preserves these 21 color keys:
...
- TapeSister colors: `WaveSelection` and `ActiveTile`.
...
Missing application-specific colors receive safe visual fallbacks and appear
