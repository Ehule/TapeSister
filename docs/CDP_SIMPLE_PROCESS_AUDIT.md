...
For the subsequent whole-suite inventory, native stereo candidates and further
process probes, see [the September 2026 expansion audit](CDP_REMAINING_PROCESS_AUDIT.md).
The results below describe the earlier mono catalog expansion.
