...
page/REC BANK TSR29 members under `project-data/`, and extractable 16-bit PCM copies of
...
ring primes four actual capture buffers (bounded to 128–8192 frames). At the
