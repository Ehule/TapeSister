...
The primary `.tsr` is page 1 and remains a normal single-page project; TSR25-aware
...
REC BANK; later pages and REC state use ordinary TSR25 members. Opening a project is
