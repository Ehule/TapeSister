...
The primary `.tsr` is page 1 and remains a normal single-page project; TSR23-aware
...
REC BANK; later pages and REC state use ordinary TSR23 members. Opening a project is
